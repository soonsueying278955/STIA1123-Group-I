...
public class Cat {
	...
	void calculateFoodCost() {
		System.out.println("Enter the food cost for cat per day: ");
	...
	void calculateClothesCost() {
		System.out.println("Enter the clothes cost for cat per day:");
		...
		double s = shirt * 31;	  // s represent shirt
		double h = hat * 31;      // h represent hat
		double amount = s + h;
